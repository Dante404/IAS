...
{
    public class ContactsUnisController : Controller
    {
        private ContattiDB2 db = new ContattiDB2();
        ...
        // GET: ContactsUnis/Create
        public ActionResult Create()
        {
            return View();
        }

        // POST: ContactsUnis/Create
